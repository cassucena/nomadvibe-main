...
<?php
	...
	$nome = $morada = $Codigo_postal = $localidade = $nif = $telefone = $aniversario = $utilizador = $password= "";
	...
	)
	{
		...
		{	
			...
			$mysqli->query("INSERT INTO CONTAS (CONTAS.UTILIZADOR, CONTAS.PASSWORD, CONTAS.ACTIVO, CONTAS.PERFIL, CONTAS.ID_UTILIZADOR, CONTAS.ROLE, CONTAS.VALIDADE) VALUES('$utilizador', '$palavra_passe', 0, 2, LAST_INSERT_ID(), 2, DATE_ADD(CURDATE(), INTERVAL +12 MONTH))");
