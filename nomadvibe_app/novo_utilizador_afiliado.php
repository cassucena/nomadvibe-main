...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
	...
	<br /><br /><br />
		...
		<div>	
            		...
            		<input type="tel" size="30" name="telefone" required pattern="[2]{1}[0-9]{8}" maxlength="9" placeholder="Telefone" required>

        	</div><br />
        
		<div>	

			<input placeholder="Data de nascimento" size="30" name="aniversario" class="textbox-n" type="text" onfocus="(this.type='date')">
